classdef Sc_NiobiumNitride3 < Superconductor
    %Sc_NiobiumNitride
    %
    ...
    properties (Constant)
        ...
        %from Toth
        theta_D = 307 * Constants.Kelvin;
        %from b and <alpha^2>

        %Zero-Temperature energy gap
        %Delta_0 = 2.22 * Constants.milli * Constants.eV;
        %from Hannif
        Delta_0 = 1.8761 * Constants.milli * Constants.eV;
